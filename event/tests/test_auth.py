...
class TestGetOptionalCurrentUser:
    ...
    async def test_optional_user_no_credentials(self):
        """Test get_optional_current_user returns None when no credentials."""
    ...
    @pytest.mark.asyncio
    async def test_optional_user_valid_token(self):
        """Test get_optional_current_user with valid token."""
        from app.middleware.auth import get_optional_current_user, get_keycloak_jwks
        from fastapi.security import HTTPAuthorizationCredentials
        ...
        with patch("app.middleware.auth.requests.get") as mock_get, \
            ...
            assert result["keycloak_id"] == "user-456"
            assert result["email"] == "optional@example.com"

    @pytest.mark.asyncio
    async def test_optional_user_missing_key(self):
        """Test get_optional_current_user returns None when key not found."""
        from app.middleware.auth import get_optional_current_user, get_keycloak_jwks
        from fastapi.security import HTTPAuthorizationCredentials
    ...
    @pytest.mark.asyncio
    async def test_optional_user_missing_claims(self):
        """Test get_optional_current_user returns None when claims missing."""
        from app.middleware.auth import get_optional_current_user, get_keycloak_jwks
        from fastapi.security import HTTPAuthorizationCredentials
        ...
        with patch("app.middleware.auth.requests.get") as mock_get, \
            ...
            mock_decode.return_value = {"some_claim": "value"}
    ...
    @pytest.mark.asyncio
    async def test_optional_user_jwt_error(self):
        """Test get_optional_current_user returns None on JWT error."""
        from app.middleware.auth import get_optional_current_user, get_keycloak_jwks
        from fastapi.security import HTTPAuthorizationCredentials
        from jose import JWTError
