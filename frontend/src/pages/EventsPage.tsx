...
export default function EventsPage() {
  ...
  return (
    <div>
      {/* Sticky Header with Search, Filters and Create Button */}
        ...
        <div className="fixed top-0 md:top-16 inset-x-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button onClick={() => setShowCreateEvent(true)} className="gap-2 h-10 flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="outline" size="sm" className="md:hidden gap-2 h-9">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-32 md:pt-32 pb-6 space-y-6">
        {/* Header */}
        <div>
        ...
        <div className="space-y-4">
          ...
          {/* Active Filters Badge - Only show on mobile */}
          {selectedType !== 'all' && (
